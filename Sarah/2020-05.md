...
J'ai participé à une visio avec Leila. J'ai appris à : 
        - faire apparaître des images grâce au scroll avec javascript. 
        - [Polyfill.io](https://polyfill.io/v3/) permet de traduire un script js pour les navigateurs non compatible
