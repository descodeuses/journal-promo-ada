...
Remote avec Laila :) : 
        ...
        - attention dans setTimeout de ne pas dire à la fonction appelée à être exécutée de s'exécuter! Sinon on créé un stack over exceedeed. ex : setTimeout(mafonction, 2000) est ok 
